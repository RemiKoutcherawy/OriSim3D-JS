// file 'test/ModelDeep.test.js
// run with mocha --require babel-polyfill --require babel-register --require should test/ModelDeep.test.js
...
// @return cross product Z = CA x CB ( > 0 means CCW)
  ...
  it('Split Bug 1', function () {
    let model = new Model();
    model.init([0, 0, 0, -200, 200, -200]);
    let p = new Vec3(-100, -100, 0);
    let n = new Vec3(200, 200, 0);
