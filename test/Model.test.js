...
describe('Model', function () {
  ...
  it('searchSegmentsOnePoint', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('searchSegmentsTwoPoints', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('faceRight faceLeft', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
    // Take point 0 (-200,-200) and point 1 (200,-200)
    let p0 = model.points[0];
  ...
  it('splitSegmentByPoint', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitSegmentOnPoint', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
    let s0 = model.segments[0];
    // p is the middle of segment s
  ...
  it('splitSegmentByRatio', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
    let s0 = model.segments[0];
...
// Origami needs robust split face by plane
  it('splitFaceByPlane No intersection', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
    let f = model.faces[0];
    ...
    let p = new Vec3(400, 0, 0); // On left
    let n = new Vec3(-1, 0, 0);
    let pl = new Plane(p, n);
  ...
  it('splitFaceByPlane Cross on X=0', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitFaceByPlane On Diagonal', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitFaceByPlane On side', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitFaceByPlane On side 3 points', function () {
    let model = new Model();
  ...
  it('splitFaceByPlane On side 4 points', function () {
    let model = new Model();
  ...
  it('splitFaceByPlane Strange case', function () {
    let model = new Model();
  ...
  it('splitFacesByPlane all faces by', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitFacesByPlane list faces by', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitFacesByPlane all faces across', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
  ...
  it('splitLineToLineByPoints', function () {
    let model = new Model();
    model.init([-200, -200, 200, -200, 200, 200, -200, 200]);
    // On diagonal
