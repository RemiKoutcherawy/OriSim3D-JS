...
test('Segment.compare', function () {
  let s1 = new Segment(new Point(0, 0, 0), new Point(30, 40, 0));
  let s2 = new Segment(new Point(0, 0, 0), new Point(30, 40, 0));
  let d = Segment.compare(s1, s2);
  ok(d === 0,"got:"+d);
  s2 = new Segment(new Point(3, 0, 0), new Point(30, 40, 0));
  d = Segment.compare(s1, s2);
  ok(d === 9,"got:"+d);
  s2 = new Segment(new Point(30, 0, 0), new Point(30, 40, 0));
  d = Segment.compare(s1, s2);
  ok(d === 900,"got:"+d);
});
test('Segment.distanceToSegment', function () {
  ...
  let p3 = new Point(0, -30, 0);
  d = Segment.distanceToSegment(s, p3);
  ok(d === 30,"got:"+d);
  p3 = new Point(30, 50, 0);
  d = Segment.distanceToSegment(s, p3);
  ok(d === 10,"got:"+d);
  p3 = new Point(30, 10, 0);
  d = Segment.distanceToSegment(s, p3);
  ok(d === 18,"got:"+d);
});
...
test('Segment.closestSeg', function () {
  ...
  let c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, p0) === 0 && Point.compare3d(c.p2, p0) === 0);

  // First segment degenerates and second segment is crossing first segment
  s2.p1.set3d(0, 100, 0);
  c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, p0) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, p0) === 0, "Got c.p2:"+c.p2);

  // First segment degenerates and second segment degenerates but is distinct
  s2.p2.set3d(0, 100, 0);
  c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, p0) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, s2.p2) === 0, "Got c.p2:"+c.p2);
  ...
  c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, p0) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(100,0,0)) === 0, "Got c.p2:"+c.p2);
  ...
  ok(Point.compare3d(c.p1, s1.p1) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(100,-100,0)) === 0, "Got c.p2:"+c.p2);
  ...
  c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, new Point(100,100,0)) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(100,100,0)) === 0, "Got c.p2:"+c.p2);
  ...
  c = Segment.closestSeg(s1, s2);
  ok(Point.compare3d(c.p1, new Point(100,100,0)) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(100,200,0)) === 0, "Got c.p2:"+c.p2);
  ...
  ok(Point.compare3d(c.p1, new Point(50,50,100)) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(50,50,0)) === 0, "Got c.p2:"+c.p2);
});
test('Segment.closestLine', function () {
  ...
  ok(Point.compare3d(c.p1, new Point(100,200,0)) === 0, "Got c.p1:"+c.p1);
  ok(Point.compare3d(c.p2, new Point(100,200,0)) === 0, "Got c.p2:"+c.p2);
