...
OrigamiObject.prototype = Object.assign(Object.create(THREE.Object3D.prototype), {
  ...
  buildMaterials: function () {
    ...
    let textureFront = textureLoader.load('textures/cocotte256x256.jpg');
    ...
    let textureBack = textureLoader.load('textures/back256x256.jpg');
  ...
  buildObjects: function () {
    ...
    // Clean eventually
    if (this.faces3dFront !== undefined) {
