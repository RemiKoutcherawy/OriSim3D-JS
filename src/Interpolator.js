...
/** @return {number} */
Interpolator.AccelerateDecelerate = function (t) {
...
Interpolator.SpringOvershoot = function (t) {
  let x = 0;
  if (t < 0.1825)
    x = (((-237.110 * t) + 61.775) * t + 3.664) * t + 0.000;
  else if (t < 0.425)
    x = (((74.243 * t) - 72.681) * t + 21.007) * t - 0.579;
  else if (t < 0.6875)
    x = (((-16.378 * t) + 28.574) * t - 15.913) * t + 3.779;
  else if (t < 1.0)
    x = (((5.120 * t) - 12.800) * t + 10.468) * t - 1.788;
  else
    x = (((-176.823 * t) + 562.753) * t - 594.598) * t + 209.669;
  return x;
};
...
Interpolator.Bounce = function (t) {
  ...
  if (t < 0.3535)
    ...
    x = bounce(t - 0.54719) + 0.7;
  else if (t < 0.9644)
    x = bounce(t - 0.8526) + 0.9;
  else
    x = bounce(t - 1.0435) + 0.95;
  return x;
};
...
Interpolator.AnticipateOvershoot = function (t) {
  ...
  let x = 0;
  if (t < 0.5)
    x = 0.5 * a(t * 2.0, mTension);
  else
    x = 0.5 * (o(t * 2.0 - 2.0, mTension) + 2.0);
  return x;
};
